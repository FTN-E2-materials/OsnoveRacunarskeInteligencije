    ...
    public partial class Main : Form
    {
        ...
        private void btnLinearRegression_Click(object sender, EventArgs e)
        {
            ...
            foreach (string line in lines)
            {
                ...
                x.Add(double.Parse(elements[28], CultureInfo.InvariantCulture)); // take Lat attribute as x value
                y.Add(double.Parse(elements[31], CultureInfo.InvariantCulture)); // take Mort attribute as y value
            }
            ...
            double regressionResult = regression.predict(5);
            Console.WriteLine("Predvideti popularnost likova koji imaju 5 " + regressionResult + "\n\n");
            regressionResult = regression.predict(10);
            Console.WriteLine("Predvideti popularnost likova koji imaju 10 " + regressionResult + "\n\n");
            regressionResult = regression.predict(15);
            Console.WriteLine("Predvideti popularnost likova koji imaju 15 " + regressionResult + "\n\n");
        ...
        private void btnKmeans_Click(object sender, EventArgs e)
        {
            ...
            {
                string[] elements = line.Split(','); // csv file split by , (comma)
                Point kmeansElement = new Point(double.Parse(elements[1]), double.Parse(elements[4]));
