...
namespace Masinsko_Ucenje
{
    ...
    public class Cluster
    {
        ...
        {   // TODO 6: implementirati funkciju rastojanja
            return Math.Abs(c.x - centar.x) + Math.Abs(c.y - centar.y) + Math.Abs(c.z - centar.z) + Math.Abs(c.j - centar.j) + Math.Abs(c.m - centar.m);
        }
        ...
        {   // TODO 7: implemenitrati funkciju koja pomera centre klastera
            ...
            if (n != 0)
            {
                Point nCentar = new Point((int)(sX / n), (int)(sY / n), (int)(sZ / n), (int)(sJ / n), (int)(sM / n));
