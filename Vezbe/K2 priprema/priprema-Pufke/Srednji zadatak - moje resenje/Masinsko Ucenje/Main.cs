    ...
    public partial class Main : Form
    {
        ...
        private void btnLinearRegression_Click(object sender, EventArgs e)
        {
            ...
            foreach (string line in lines)
            {
                ...
                x.Add(double.Parse(elements[1])); // take Lat attribute as x value
                y.Add(double.Parse(elements[2])); // take Mort attribute as y value
            }
        ...
        private void btnKmeans_Click(object sender, EventArgs e)
        {
            ...
            {
                string[] elements = line.Split(','); // csv file split by , (comma)
                Point kmeansElement = new Point(double.Parse(elements[16], CultureInfo.InvariantCulture), double.Parse(elements[17], CultureInfo.InvariantCulture), double.Parse(elements[18], CultureInfo.InvariantCulture), double.Parse(elements[19], CultureInfo.InvariantCulture), double.Parse(elements[20], CultureInfo.InvariantCulture));
