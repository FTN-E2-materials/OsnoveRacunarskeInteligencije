...
namespace Lavirint
{
    public class State
    {
        ...
        public double cost;
        public int skupljenBrojZastavica = 0;
        ...
        public State sledeceStanje(int markI, int markJ)
        {
            ...
            rez.skupljenBrojZastavica = this.skupljenBrojZastavica;
            rez.listaSakupljenihKutija.AddRange(this.listaSakupljenihKutija);
            return rez;
        }

        //Perica mora da skupi 3 sazstavice, zastavice su place boje
        public List<State> mogucaSledecaStanja()
        {
            ...
            if (lavirint[markI, markJ] == 4 && !this.listaSakupljenihKutija.Contains(100 * markI + markJ)){
                 this.skupljenBrojZastavica += 1;
                 this.listaSakupljenihKutija.Add(100 * markI + markJ);
            }

            if (skupljenBrojZastavica < 3) {//Kretnja kao Konj skakac
        ...
        { 
            return Main.krajnjeStanje.markI == markI && Main.krajnjeStanje.markJ == markJ && this.skupljenBrojZastavica == 3;
        }
