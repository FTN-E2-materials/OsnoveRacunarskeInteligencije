...
namespace Lavirint
{
    public partial class DisplayPanel : UserControl
    {
        ...
        {
            visited[state.trenutniCvor.kordinataI, state.trenutniCvor.kordinataJ] = true;
        }
        ...
        public void moveIcon(int dI, int dJ) { 
            ...
            if (Main.lavirint.polja[nI,nJ] != 1) {
                iconI = nI;
                iconJ = nJ;
                Main.manualRobotPozicija.kordinataI = iconI;
                Main.manualRobotPozicija.kordinataJ = iconJ;
